...
const Navbar = ()=>{
    return (
        <>
            ...
            <ul>
                <li><NavLink to="/" style={({isActive})=>{return {color : isActive ? "red" : "",textDecoration: 'none' } }}>Home</NavLink></li>
                <li><NavLink to="/about" style={({isActive})=>{return {color : isActive ? "red" : "",textDecoration: 'none' }}}>About</NavLink></li>
                <li><NavLink to="/contact" style={({isActive})=>{return {color : isActive ? "red" : "",textDecoration: 'none' }}}>Contact</NavLink></li>
